...
<span data-proof="authored" data-by="ai:claude">Read with</span> <span data-proof="authored" data-by="ai:claude">`validation-rule-generate/SKILL.md`. Procedure lives here.</span>
