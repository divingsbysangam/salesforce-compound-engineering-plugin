...
- **Patterns to follow:** the upstream `sf-code-review` "confidence-gated findings" pattern; the persona cross-reference style already used for `../sf-review/references/personas/`.
- **Test scenarios:**
...
- Prior related plan: `docs/plans/2026-03-02-feat-close-teardown-gaps-plan.md` (the ** teardown — distinct lineage; this plan does not overlap it).
